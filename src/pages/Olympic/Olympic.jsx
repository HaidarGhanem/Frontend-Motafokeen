  ...
  {loading ? (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {allOlympics.map((olympic) => (
        <div key={olympic._id} className="bg-white rounded-2xl shadow-lg p-6 flex flex-col justify-between hover:shadow-xl transition-all duration-200">
          {/* Header with Name & Class */}
          <div className="mb-4">
